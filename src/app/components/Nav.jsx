...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`z-50 fixed cursor-pointer sm:hidden top-0 left-0 h-screen w-full bg-[#151515] text-white transform transition-transform duration-300 ${isMobileMenuOpen ? 'translate-y-0' : 'translate-y-full'
          }`}
      >
