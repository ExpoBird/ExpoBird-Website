          ...
          <div>
            ...
            <form>
              <label className="block ">
                ...
                />
                <button className="text-white sm:mt-[20px] sm:ml-[100px] sm:mb-[52px] mb-10 mt-[40px] text-[17px] lg:ml-[140px] bg-[#7B41F9] rounded-[70px] py-4 px-6 font-semibold md:flex md:items-center md:m-auto md:mb-10 md:mt-10">
                  Contact Us{" "}
                  <span>
                    <Image
                      src={"/assets/Send.svg"}
