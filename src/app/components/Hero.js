          ...
          <div className="w-full">
              <section className="py-24 sm:py-4 md:py-30 w-full sm flex items-center justify-center">
                  <div className="text-center">
                      <h6 className="sm:text-[45px] md:text-[70px] inline text-[80px] text-white font-black sm:leading-none">NEXT GENERATI<span className="gradient-text">O</span>N</h6>
                      <div className="mt-[24px] md:text-[30px] rotating-words text-center relative">
                          <span className="sm:text-[45px] md:text-[50px] block text-[80px] text-white font-black bg-color-1 rounded-[60px] left-1/2 -translate-x-2/4 px-8">Animation</span>
                          <span className="sm:text-[45px] md:text-[50px] block text-[80px] text-white font-black bg-color-1 rounded-[60px] left-1/2 -translate-x-2/4 px-8">Design</span>
                          <span className="sm:text-[45px] md:text-[50px] block text-[80px] text-white font-black bg-color-1 rounded-[60px] left-1/2 -translate-x-2/4 px-8">Environment</span>
                          <span className="sm:text-[45px] md:text-[50px] block text-[80px] text-white font-black bg-color-1 rounded-[60px] left-1/2 -translate-x-2/4 px-8">Physics</span>
                          <span className="sm:text-[45px] md:text-[50px] block text-[80px] text-white font-black bg-color-1 rounded-[60px] left-1/2 -translate-x-2/4 px-8">Creations</span>
                      </div>
                      ...
                      <button className="bg-color-1 right-[70px] justify-end px-6 py-4 rounded-[40px] text-white text-[17px] font-semibold">
