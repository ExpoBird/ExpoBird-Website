...
export default function Testimonials() {
  return (
    <>
      <p className='text-white bg-[#0045e5] font-montserrat placeholder:text-white sm:text-[40px] text-[85px] font-bold sm:font-extrabold text-center sm:text-center'>Testimonials</p>
      <Swiper
        effect={'coverflow'}
        grabCursor={true}
        slidesPerView={'auto'}
