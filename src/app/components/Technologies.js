    ...
    <Fragment>
      <div className="font-montserrat sm:px-10 mt-10  mb-10 sm:mb-10  xl:px-36 px-0 relative z-10">
        <div className="py-[3rem] sm:py-[1rem]">
          ...
          <h5 className="xl:hidden 2xl:hidden md:text-[50px] lg:hidden sm:text-[40px] sm:leading-none sm:text-center mt-10 sm:mt-0 ml-[60px] sm:m-6 md:m-3 text-[80px] text-black font-bold">
            Our Technologies
          </h5>
        </div>
