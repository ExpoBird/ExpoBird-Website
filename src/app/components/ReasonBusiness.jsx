...
const ReasonBusiness = ({greenTitle,whiteTitle,heading1,paragraph1,heading2,paragraph2,heading3,paragraph3,heading4,paragraph4,heading5,paragraph5}) => {
  return (
    <>
      <div className="bg-[#151515] grid grid-cols-3 sm:grid-cols-1 border-t border-[#FFF] font-montserrat">
            <div className="pl-24 sm:pl-0 border-r sm:border-0 border-[#BDBDBD] py-24 sm:pb-14">
              <h6 className="text-[85px] text-[#00A256] font-bold leading-none sm:text-[45px] sm:text-center">{greenTitle}</h6>
              <h6 className="text-[85px] text-white font-bold max-w-[400px] leading-none sm:text-[45px] sm:text-center">{whiteTitle}</h6>
            </div>
