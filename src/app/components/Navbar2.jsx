...
const Navbar2 = () => {
	...
	return (
		<Fragment>
			...
			{
				<aside className={showNav ? "sm:bg-[#080a1e] font-montserrat sm:h-[790px] sm:mt-[40px] sm:absolute sm:w-full cursor-pointer sm:text-white accordion-nav md:hidden lg:hidden xl:hidden 2xl:hidden" : "hidden sm:bg-[#151515] cursor-pointer sm:absolute font-montserrat sm:text-white sm:w-full sm:h-[740px] sm:mt-[20px] accordion-nav md:hidden lg:hidden xl:hidden 2xl:hidden"}>
