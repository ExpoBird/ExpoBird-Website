    ...
    <>
      <div className="sm:hidden px-24 font-montserrat flex items-center justify-center bg-[#151515] relative">
        <div className="w-full">
          ...
          <Image src="/assets/logo.svg" width={150} height={50} alt="" />
      ...
      <div
        className={`z-50 fixed cursor-pointer top-0 left-0 h-screen w-full bg-[#151515] text-white transform transition-transform duration-300 ${
