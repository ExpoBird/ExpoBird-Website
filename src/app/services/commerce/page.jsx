    ...
    return (
        <>
         ...
         title2={" development solutions to empower startups, SMBs, enterprises and brands."}
          text1={"We Are #1"} text2={"E Commerce Development"} text3={"Company Dubai"}
        />
            </div>
            <OurService2 title={"Choose Expobird as your e-commerce development and propel your business to new heights with our award-winning Web Development services and proprietary technology platform."} />
